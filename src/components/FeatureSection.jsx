...
const FeatureSection = () => {
  return (
    <div id="feature" className="relative mt-10 border-b border-neutral-800 min-h-[400px]">
      <div className="text-center">
        <span className="inline-block bg-neutral-900 text-orange-500 rounded-full h-6 text-sm font-medium px-3 py-1 uppercase">
          Features
        </span>

        <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-5 md:mt-10 lg:mt-10 tracking-wide">
          Easy Build{" "}
