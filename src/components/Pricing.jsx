                    ...
                    <div className="p-10 border border-neutral-700  rounded-xl">
                        ...
                        <ul>
                            {option.features.map((feature,index) => (
                                <li key={index} className="text-orange-400 mt-8 flex items-center">
                                    <CheckCircle2/>
                                    <span className="ml-2 text-white">{feature}</span>
                                </li>
                            ))}
                        </ul>
                        <a href="#" className="inline-flex justify-center items-center text-center text-xl w-full h-12 p-5 mt-20 tracking-tight hover:bg-orange-900 border border-orange-900 rounded-lg transition duration-200 ">Subscribe</a>
                    </div>
                </div>
            ))}
        </div>
